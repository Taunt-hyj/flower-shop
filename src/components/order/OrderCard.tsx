    ...
    return (
        <View style={{ padding: 5, borderRadius: 20, backgroundColor: colors.white }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 10 }}>
                ...
                <TouchableOpacity activeOpacity={0.8} key={0} onPress={() => navigation.navigate(navigationNames.orderScreen, { id: 0 })}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 10, paddingHorizontal: 30 }}>
                <TouchableOpacity activeOpacity={0.8} key={0} onPress={() => navigation.navigate(navigationNames.orderScreen, { id: 1 })}>
                ...
                <TouchableOpacity activeOpacity={0.8} key={0} onPress={() => navigation.navigate(navigationNames.orderScreen, { id: 2 })}>
                    <View style={{ alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <TouchableOpacity activeOpacity={0.8} key={0} onPress={() => navigation.navigate(navigationNames.orderScreen, { id: 3 })}>
                    <View style={{ alignItems: 'center', justifyContent: 'space-between' }}>
